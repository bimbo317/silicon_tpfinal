            ...
            <div class="col-lg-12 col-xl-12 offset-xl-0 d-lg-flex justify-content-lg-center">
                <div class="card shadow mb-3" style="background: rgba(255,255,255,0.77);">
                    <div class="card-header py-3">
                        <p class="text-center m-0 fw-bold" style="font-size: 32px;text-shadow: 5px 4px 7px rgb(150,129,40);color: rgb(143,60,16);">Editar Cliente</p>
                    </div>
                    <div class="card-body">
                        <form action="../SvMdfCli" method="POST">
                            <%
                                ...
                                String nacio = cliente.getNacionalidad();
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group mb-3"><label class="form-label" for="nationality"><strong>DNI</strong></label><input class="form-control" type="text" placeholder="dni number" name="dni" required value="<%=dni%>"></div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="form-group mb-3"><label class="form-label" for="first_name"><strong>Nombre</strong></label><input class="form-control" type="text" placeholder="John" name="name" required value="<%=nombre%>"></div>
                                </div>
                                <div class="col">
                                    <div class="form-group mb-3"><label class="form-label" for="last_name"><strong>Apellido</strong></label><input class="form-control" type="text" placeholder="Doe" name="last_name" required value="<%=apellido%>"></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group mb-3"><label class="form-label" for="nationality"><strong>Fecha de Nacimiento</strong></label><input class="form-control" type="date" name="date" required value="<%=fecNac%>"></div>
                                </div>
                                <div class="col">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group mb-3"><label class="form-label" for="first_name"><strong>Dirección</strong></label><input class="form-control" type="text" placeholder="Street and number" name="address" required value="<%=cel%>"></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group mb-3"><label class="form-label" for="first_name"><strong>Teléfono</strong></label><input class="form-control" type="text" placeholder="261555555" name="phone" required value="<%=dni%>"></div>
                                </div>
                                <div class="col">
                                    <div class="form-group mb-3"><label class="form-label" for="nationality"><strong>Email</strong></label><input class="form-control" type="email" placeholder="mail@mail.com" name="email" required value="<%=mail%>"></div>
                                </div>
                            </div>
