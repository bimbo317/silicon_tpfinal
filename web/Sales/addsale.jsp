            ...
            <div class="col-lg-12 col-xl-12 offset-xl-0 d-lg-flex justify-content-lg-center">
                <div class="card shadow mb-3" style="background: rgba(255,255,255,0.77);">
                    <div class="card-header py-3">
                        <p class="text-center m-0 fw-bold" style="font-size: 32px;text-shadow: 5px 4px 7px rgb(150,129,40);color: rgb(143,60,16);">Nueva Venta</p>
                    </div>
                    <div class="card-body">
                        <form name="frmventa" id="frmpackage" action="../SvVenta" method="POST">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="col-2">
                                                        <input type="radio" name="idCliente" class="btn-check" id="<%=idCliente%>" value="<%=idCliente%>">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="col-2">
                                                        <input type="radio" name="srvpkg" class="btn-check" id="<%=idServicio%>" value="S<%=idServicio%>">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="col-2">
                                                        <input type="radio" name="srvpkg" class="btn-check" id="<%=idPaquete%>" value="P<%=idPaquete%>">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="col-2">
                                                        <input type="radio" class="btn-check" id="efectivo" name="medioPago" value="efectivo">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="col-2">
                                                        <input type="radio" class="btn-check" id="debito" name="medioPago" value="debito">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="col-2">
                                                        <input type="radio" class="btn-check" id="credito" name="medioPago" value="credito">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="col-2">
                                                        <input type="radio" class="btn-check" id="transferencia" name="medioPago" value="transferencia">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="col-2">
                                                        <input type="radio" class="btn-check" id="monevirtual" name="medioPago" value="monevirtual">
