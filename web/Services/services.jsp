                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                for (Servicio unServicio : listaServicios) {
                                                    ...
                                                    String costo = "$ " + unServicio.getCosto_servicio();
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-2">
                                                    <form name="frmLstSrv" action="../SvLstSrv" method="post" style="display:inline">
                                                    ...
                                                    <form name="frmLstSrv" action="../SvLstSrv" method="get" style="display:inline">
                                                        <input type="hidden" name="id" value="<%=id%>">
