                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-1"><span class="text-muted">$ <%=precio%></span><br>
                                                <td class="col-2">
                                                    <button class="btn btn-info btn btn-outline-info btn-circle btn-lg" type="button" title="Ventas de este Paquete" style="background: rgb(254,254,254);"><i class="fa fa-shopping-cart"></i>
                                                    </button>
                                                    <form name="frmLstPkg" action="../SvLstPkg" method="post" style="display:inline">
