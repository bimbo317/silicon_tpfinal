            ...
            <div class="col-lg-12 col-xl-12 offset-xl-0 d-lg-flex justify-content-lg-center">
                <div class="card shadow mb-3" style="background: rgba(255,255,255,0.77);">
                    <div class="card-header py-3">
                        <p class="text-center m-0 fw-bold" style="font-size: 32px;text-shadow: 5px 4px 7px rgb(150,129,40);color: rgb(143,60,16);">Nuevo Paquete</p>
                    </div>
                    <div class="card-body">
                        <p>Seleccione los servicios que desea incluir en el nuevo paquete</p>
                        <form name="frmpackage" id="frmpackage" action="../SvPackage" method="POST">
                            <table class="table">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-2">
                                            ...
                                            <input type="checkbox" name="idcheck" class="btn-check" id="<%=id%>" value="<%=id%>" autocomplete="off" onclick="sumar()">
