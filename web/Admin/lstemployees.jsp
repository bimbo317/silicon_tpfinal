            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title text-uppercase mb-0">Empleados</h5>
                            </div>
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" class="border-0 text-uppercase font-medium">F.Nac./Sueldo</th>
                                                <th scope="col" class="border-0 text-uppercase font-medium">Puesto</th>
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                for (Empleado empleado : listaEmpleados) {
                                                    ...
                                                    String nombre = empleado.getApellido() + " " + empleado.getNombre();
                                                    String dire = empleado.getDireccion();
                                                    String dni = empleado.getDni();
                                                    String nacion = empleado.getNacionalidad();
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-3">
                                                    <h5 class="font-medium mb-0"><%=nombre%></h5><span class="text-muted"><%=dire%></span>
                                                </td>
                                                <td class="col-1"><span class="text-muted"><%=dni%></span><br><span class="text-muted"><%=nacion%></span></td>
                                                <td class="col-2"><span class="text-muted"><%=mail%></span><br><span class="text-muted"><%=cel%></span></td>
                                                <td class="col-1"><span class="text-muted"><%=fecNac%></span><br><span class="text-muted"><%=sueldo%></span></td>
                                                <td class="col-1"><span class="text-muted"><%=cargo%></span><br><span class="text-muted"></span></td>
                                                <td class="col-1"><span class="text-muted"><%=usuario%></span><br><span class="text-muted"><%=estado%></span></td>
                                                <td class="col-2">
                                                    <form name="frmLstEmplo" action="../SvLstEmplo" method="post" style="display:inline">
                                                    ...
                                                    <form name="frmLstEmplo" action="../SvLstEmplo" method="get" style="display:inline">
                                                        <input type="hidden" name="id" value="<%=id%>">
