            ...
            <div class="col-lg-12 col-xl-12 offset-xl-0 d-lg-flex justify-content-lg-center">
                <div class="card shadow mb-3" style="background: rgba(255,255,255,0.77);">
                    <div class="card-header py-3">
                        <p class="text-center m-0 fw-bold" style="font-size: 32px;text-shadow: 5px 4px 7px rgb(150,129,40);color: rgb(143,60,16);">Editar Empleado</p>
                    </div>
                    <div class="card-body">
                        <form action="../SvMdfEmplo" method="POST">                            
                            <%
                                Empleado empleado = (Empleado) request.getSession().getAttribute("empleado");
                                Long id = empleado.getId();
                                Integer cod = empleado.getCod_empleado();
                                String dni = empleado.getDni();
                                String nombre = empleado.getNombre();
                                String apellido = empleado.getApellido();
                                SimpleDateFormat sdf = new SimpleDateFormat("YYYY-MM-dd");
                                sdf.setTimeZone(TimeZone.getTimeZone("America/Argentina"));
                                String fecNac = sdf.format(empleado.getFechaNac());
                                String nacio = empleado.getNacionalidad();
                                String dire = empleado.getDireccion();
                                String cel = empleado.getCelular();
                                ...
                                String pass = empleado.getUsuario().getContrasenia();
                            %>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group mb-3"><label class="form-label" for="dni"><strong>DNI</strong></label><input class="form-control" type="text" placeholder="dni number" name="dni" value="<%=dni%>"></div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="form-group mb-3"><label class="form-label" for="name"><strong>Nombre</strong></label><input class="form-control" type="text" placeholder="John" name="name" value="<%=nombre%>"></div>
                                </div>
                                <div class="col">
                                    <div class="form-group mb-3"><label class="form-label" for="last_name"><strong>Apellido</strong></label><input class="form-control" type="text" placeholder="Doe" name="last_name" value="<%=apellido%>"></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group mb-3"><label class="form-label" for="date"><strong>Fecha de Nacimiento</strong></label><input class="form-control" type="date" name="date" value="<%=fecNac%>"></div>
                                </div>
                                <div class="col">
                                    <div class="form-group mb-3"><label class="form-label" for="nationality"><strong>Nacionalidad</strong></label><!-- Start: nationality --><select class="form-select" name="nationality">
                                            <option value="<%=nacio%>" selected=""><%=nacio%></option>
                                        ...
                                        </select><!-- End: nationality -->
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group mb-3"><label class="form-label" for="address"><strong>Dirección</strong></label><input class="form-control" type="text" placeholder="street and address" name="address" value="<%=dire%>"></div>
                                </div>
                                <div class="col">
                                    <div class="form-group mb-3"><label class="form-label" for="phone"><strong>Teléfono</strong></label><input class="form-control" type="text" placeholder="+549 261 123 4567" name="phone" value="<%=cel%>"></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group mb-3"><label class="form-label" for="job"><strong>Puesto</strong></label><input class="form-control" type="text" placeholder="empleado" name="job" value="<%=cargo%>"></div>
                                </div>
                                <div class="col">
                                    <div class="form-group mb-3"><label class="form-label" for="salary"><strong>Salario</strong></label><input class="form-control" type="text" placeholder="$ 00,00" name="salary" value="<%=sueldo%>"></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group mb-3"><label class="form-label" for="user"><strong>Usuario</strong></label><input class="form-control" type="text" placeholder="user" name="user" value="<%=usuario%>"></div>
                                </div>
                                <div class="col">
                                    <div class="form-group mb-3"><label class="form-label" for="email"><strong>Email</strong></label><input class="form-control" type="email" placeholder="mail@mail.com" name="email" value="<%=mail%>"></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group mb-3"><label class="form-label" for="pass"><strong>Password</strong></label><input class="form-control" type="password" placeholder="******" name="pass" value="<%=pass%>"></div>
                                </div>
                                <div class="col">
                                    <div class="form-group mb-3"><label class="form-label" for="pass2"><strong>Confirmar Password</strong></label><input class="form-control" type="password" placeholder="******" name="pass2" value="<%=pass%>"></div>
                                </div>
                            </div>
